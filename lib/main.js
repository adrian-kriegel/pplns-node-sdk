...
exports.PipelineNode = exports.buildSearchParams = exports.stringifyQuery = exports.stringifyQueryValue = void 0;
...
class PipelineApi {
    ...
    async registerWorker(worker) {
        ...
        const result = await this.client.post('/workers', worker);
